...
import {
  Grid, Button, Stack, Box, Typography,
  styled,
  TextField,
  Modal,
  Backdrop,
    ...
    <Box mb={0} id="hero">
      <Box>
        <h2>  <Typography variant="h4" sx={{
          ...
          fontWeight: '500'
        }}>Giải pháp dữ liệu cho mọi doanh nghiệp </Typography></h2>
      </Box>
        ...
        <Grid item xs={5}>
          <div style={{ margin: "70px 0px 0px 50px" }} >
            ...
            <Stack spacing={2} direction="row" sx={{ marginTop: "30px" }}>
              ...
              <Button variant="outlined" color="secondary"><a href="#signup" >Đến với chúng tôi</a></Button>
